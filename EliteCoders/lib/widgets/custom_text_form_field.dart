...
class CustomTextFormField extends StatelessWidget {
  CustomTextFormField({
    ...
    this.filled = true,
    this.validator,
    this.readOnly = false, // New property for making the field non-editable
  }) : super(
    key: key,
  );
  ...
  final bool? readOnly; // New property for making the field non-editable
  ...
  Widget textFormFieldWidget(BuildContext context) => SizedBox(
    ...
    child: TextFormField(
      readOnly: readOnly ?? false, // Set readOnly property
      scrollPadding:
